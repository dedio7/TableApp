...
class AppSettings(private val context: Context) {
    ...
    val clockColor: Flow<Long> = context.dataStore.data.map { it[CLOCK_COLOR] ?: 0xFFE8E8E8 }
    ...
    val bgPrimaryColor: Flow<Long> = context.dataStore.data.map { it[BG_PRIMARY_COLOR] ?: 0xFF0D0D0D }
    val bgSecondaryColor: Flow<Long> = context.dataStore.data.map { it[BG_SECONDARY_COLOR] ?: 0xFF1A1A2E }
